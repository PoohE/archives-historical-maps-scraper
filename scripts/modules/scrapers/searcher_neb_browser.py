...
Примеры:
    python -B scripts/modules/scrapers/searcher_neb_browser.py "карта Калужская губерния" \
        --output output/neb_browser_smoke_20260909
    python -B scripts/modules/scrapers/searcher_neb_browser.py --all-queries \
