...
python scripts/modules/scrapers/searcher_garf_fixed.py "карта" --debug
```
...
```bash
python scripts/modules/scrapers/searcher_garf_fixed.py "карта" --debug > output/garf_html_dump.txt
```
...
Файл: `scripts/modules/scrapers/searcher_garf_fixed.py`
...
```bash
python scripts/modules/scrapers/searcher_garf_fixed.py "карта Смоленская"
```
...
Файл: `scripts/modules/scrapers/searcher_kaluga_fixed.py`
...
```bash
python scripts/modules/scrapers/searcher_kaluga_fixed.py "карта Калужская"
```
...
Файл: `scripts/modules/scrapers/searcher_permkrai_fixed.py`
...
```bash
python scripts/modules/scrapers/searcher_permkrai_fixed.py "карта"
```
...
Файл: `scripts/modules/scrapers/searcher_smolensk_fixed.py`
...
```bash
python scripts/modules/scrapers/searcher_smolensk_fixed.py
```
...
Файл: `scripts/modules/scrapers/searcher_rgb_fixed.py`
...
```bash
python scripts/modules/scrapers/searcher_rgb_fixed.py "карта"
```
...
Файл: `scripts/modules/scrapers/searcher_cga_moskva_fixed.py`
...
```bash
python scripts/modules/scrapers/searcher_cga_moskva_fixed.py "карта"
```
...
Файл: `scripts/modules/scrapers/searcher_gako_fixed.py`
...
```bash
python scripts/modules/scrapers/searcher_gako_fixed.py "карта"
```
