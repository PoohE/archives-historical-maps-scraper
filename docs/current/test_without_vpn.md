...
```bash
python scripts/modules/scrapers/searcher_kaluga.py "карта Калужская губерния" --debug
python scripts/modules/scrapers/searcher_kaluga.py --db RK --debug
```
...
```bash
python scripts/modules/scrapers/searcher_permkrai.py "карта Пермская губерния" --debug
python scripts/modules/scrapers/searcher_permkrai.py --check-node 33626
```
...
```bash
python scripts/modules/scrapers/searcher_smolensk.py --geo-only --debug
python scripts/modules/scrapers/searcher_smolensk.py --max-pages 3 --debug
```
...
python scripts/modules/scrapers/searcher_sverdlovsk.py --check-ses

# Тест поиска с дампом HTML
python scripts/modules/scrapers/searcher_sverdlovsk.py --geo Перм --debug

# Полный запрос все 4 губернии
python scripts/modules/scrapers/searcher_sverdlovsk.py
```
...
```bash
python scripts/check_source.py neb
```
...
```bash
python scripts/check_source.py rsl
```
...
```bash
python scripts/check_source.py rosarchive
```
